...
def _gym_register_as_decorator(func: Callable[..., gym.Env],
                               id_base: str,
                               *, module_name: str, id_prefix: str = "",
                               **register_kwargs,
                               ) -> Callable[..., gym.Env]:
...
def curried_gym_register_as_decorator(module_name: str,
    ...
    def build_decorator(id_base: str, *args, **kwargs) -> Callable:
        return partial(_gym_register_as_decorator,
                       *args,
                       id_base=id_base,
